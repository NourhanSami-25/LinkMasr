...
<head>
	...
	<title>Link Masr | Create Support Request</title>
					...
					<div class="d-flex flex-column flex-column-fluid">
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<h1
											...
											{{ __('general.create_new_support_request') }}</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">{{ __('general.support_requests') }}</li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
												<span class="bullet bg-gray-500 w-5px h-2px"></span>
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Form-->
								<form action="{{route('support-requests.store')}}" method="POST" class="form d-flex flex-column flex-lg-row"
												...
												<div class="d-flex flex-column gap-7 gap-lg-10 mb-10">
													...
													<div class="card card-flush py-4">
														...
														<div class="card-body pt-0">
															...
															<!--begin::InpudRow - Support Type and Purpose -->
															<div class="d-flex flex-wrap gap-5 mb-5">
																<!--begin::Input group-->
																<div class="fv-row w-100 flex-md-root">
																	<!--begin::Label-->
																	<label class="form-label">{{ __('general.support_type') }}</label>
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="support_type" data-label="{{ __('general.support_type') }}"
																		data-control="select2" data-hide-search="true"
																		data-placeholder="{{ __('general.select_an_option') }}">
																		<option></option>
																		<option value="technical">{{ __('general.technical_support') ?? 'دعم فني' }}</option>
																		<option value="consultation">{{ __('general.consultation') ?? 'استشارة' }}</option>
																		<option value="training">{{ __('general.training') ?? 'تدريب' }}</option>
																		<option value="other">{{ __('general.other') ?? 'أخرى' }}</option>
																	</select>
																	<!--end::Select2-->
																</div>
																<!--end::Input group-->
																...
																<div class="fv-row w-100 flex-md-root">
																	<!--begin::Label-->
																	<label class="form-label">{{ __('general.support_purpose') }}</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="purpose" data-label="{{ __('general.support_purpose') }}" class="form-control mb-2" value="{{ old('purpose') }}" maxlength="255"/>
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
															</div>
															...
															<!--begin::InpudRow - Support Dates -->
															<div class="d-flex flex-wrap gap-5 mb-5">
																<!--begin::Input group-->
																<div class="fv-row w-100 flex-md-root">
																	<!--begin::Label-->
																	<label class="form-label">{{ __('general.support_start_date') }}</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input class="flatpickr-date form-control mb-2" name="start_date" data-label="{{ __('general.support_start_date') }}"
																	placeholder="{{ __('general.select_a_date') }}"/>
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="fv-row w-100 flex-md-root">
																	<!--begin::Label-->
																	<label class="form-label">{{ __('general.support_end_date') }}</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input class="flatpickr-date form-control mb-2" name="end_date" data-label="{{ __('general.support_end_date') }}"
																	placeholder="{{ __('general.select_a_date') }}"/>
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
