...
<head>
	...
	<title>Link Masr | Create Money Request</title>
					...
					<div class="d-flex flex-column flex-column-fluid">
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<h1
											...
											{{ __('general.create_new_money_request') }}</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">{{ __('general.money_requests') }}</li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
												<span class="bullet bg-gray-500 w-5px h-2px"></span>
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Form-->
								<form action="{{route('money-requests.store')}}" method="POST" class="form d-flex flex-column flex-lg-row"
														...
														<div class="card-body pt-0">
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<input type="number" name="amount" data-label="{{ __('general.amount') }}" class="form-control mb-2" value="{{ old('amount') }}" max="10000000" data-required="true"/>
																	<!--end::Select2-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2 task-relation-type" name="related" data-label="{{ __('general.related') }}"
																		data-control="select2" data-hide-search="true"
																		data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																		<option></option>
																		<option value="task">{{ __('general.task') }}</option>
																		<option value="project">{{ __('general.project') }}</option>
																...
																<div class="fv-row w-100 flex-md-root secondary-selects select-task">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="task" data-label="{{ __('general.task') }}"
																...
																<div class="fv-row w-100 flex-md-root secondary-selects select-project"  style="display: none;">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="project" data-label="{{ __('general.project') }}"
																		data-control="select2" id="project_subject"
																		data-placeholder="{{ __('general.select_an_option') }}">
																		<option></option>
																		@foreach($projects as $project)
																			<option value="{{$project->subject}}">{{$project->subject}}</option>
																		@endforeach
																	</select>
																	<!--end::Select2-->
																</div>
																...
																<div class="fv-row w-100 flex-md-root secondary-selects select-client" style="display: none;">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="client" data-label="{{ __('general.client') }}"
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<input id="end_date" name="end_date" data-label="{{ __('general.end_date') }}" class="flatpickr-date form-control mb-2"
																		value="{{ old('end_date') }}" data-type="end_date" data-required="true"/>
																	<!--end::Input-->
																	<!--begin::error-->
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<select class="form-select mb-2 duration_type" name="duration_type" data-label="{{ __('general.type') }}"
																		...
																		<option value="hours">{{ __('general.hours') }}</option>
																	</select>
																	<!--end::Select2-->
																</div>
																<!--end::Input group-->
