...
<head>
	...
	<title>Link Masr | Create Workhome Request</title>
					...
					<div class="d-flex flex-column flex-column-fluid">
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<h1
											...
											{{ __('general.create_new_workhome_request') }}</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">{{ __('general.workhome_requests') }}</li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
												<span class="bullet bg-gray-500 w-5px h-2px"></span>
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Form-->
								<form action="{{route('workhome-requests.store')}}" method="POST" class="form d-flex flex-column flex-lg-row"
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<select class="form-select mb-2 duration_type" name="duration_type" data-label="{{ __('general.type') }}"
																		...
																		data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																		<option></option>
																		<option value="days">{{ __('general.days') }}</option>
																		<option value="hours" selected>{{ __('general.hours') }}</option>
																	</select>
																	<!--end::Select2-->
																</div>
																<!--end::Input group-->
