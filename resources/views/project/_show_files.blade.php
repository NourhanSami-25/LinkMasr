<!--begin::Content-->
<div class="tab-pane fade" id="kt_project_view_files" role="tabpanel">
...
<div class="card pt-4 mb-6 mb-xl-9">
    ...
    <div class="card-header border-0">
        ...
        <div class="card-title">
            <h2>{{ __('general.project_files') }}</h2>
        </div>
        <!--end::Card title-->
        ...
        <div class="card-toolbar">
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="#" class="btn btn-flex btn-primary h-40px fs-7 fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target_upload_file" data-category="project">{{ __('general.upload_new_file') }}</a>
            </div>
        </div>
        <!--end::Card toolbar-->
        @endhasAccess
        ...
        <table class="table align-middle table-row-dashed kt-datatable gy-5"
            ...
            <tbody class="fs-6 fw-semibold text-gray-800">
                ...
                <tr>
                    ...
                    <td class="text-start" class="text-start"><a href="{{ route('files.preview', $file->id) }}" class="text-gray-800 text-hover-primary mb-1" target="_blank">{{$file->name}}</a></td>
...
@include('common.file.upload_file', ['item' => $project , 'category' => 'project'])
