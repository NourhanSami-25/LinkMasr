...
<head>
	...
	<title>Link Masr | Create Department</title>
					...
					<div class="d-flex flex-column flex-column-fluid">
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Form-->
								<form action="{{route('departments.store')}}" method="POST" class="form d-flex flex-column flex-lg-row"
														...
														<div class="card-body pt-0">
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="sector_id" data-label="{{ __('general.sector') }}"
																		data-control="select2"
																		data-placeholder="{{ __('general.select_an_option') }}">
																		<option></option>
																		@foreach($sectors as $sector)
        																    <li></li>
																			<option value="{{$sector->id}}">{{$sector->subject}}</option>
        																@endforeach
																	</select>
																	<!--end::Select2-->
																</div>
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="subject" data-label="{{ __('general.subject') }}" class="form-control mb-2" value="{{ old('subject') }}" data-required="true" data-minlength="2" data-maxlength="255"/>																		
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
                                                                <!--begin::Input group-->
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="email" name="email" data-label="{{ __('general.email') }}" class="form-control mb-2" value="{{ old('email') }}"/>																		
																	<!--end::Input-->
                                                                    <!--begin::Description-->
                                                            ...
                                                            <div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="manager_id" data-label="{{ __('general.manager') }}"
																		data-control="select2"
