...
<head>
	...
	<title>Link Masr | Update Department</title>
					...
					<div class="d-flex flex-column flex-column-fluid">
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<h1
											...
											{{ __('general.create_new_department') }}</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">
												<a href="{{ route('departments.index')}}" class="text-muted text-hover-primary">{{ __('general.departments') }}</a>
											</li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Form-->
								<form action="{{route('departments.update' , $department->id)}}" method="POST" class="form d-flex flex-column flex-lg-row"
														...
														<div class="card-body pt-0">
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	<!--begin::Label-->
																	<label class="form-label">{{ __('general.sector') }}</label>
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="sector_id" data-control="select2" data-placeholder="{{ __('general.select_an_option') }}">
                                                                        <option></option>
                                                                        @foreach($sectors as $sector)
                                                                            <option value="{{ $sector->id }}" {{ $department->sector_id == $sector->id ? 'selected' : '' }}>{{ $sector->subject }}</option>
                                                                        @endforeach
                                                                    </select>
																	<!--end::Select2-->
																</div>
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="subject" class="form-control mb-2" value="{{ $department->subject }}" data-required="true" data-minlength="2" data-maxlength="255"/>																		
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
                                                                <!--begin::Input group-->
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="email" name="email" class="form-control mb-2" value="{{ $department->email }}"/>																		
																	<!--end::Input-->
                                                                    <!--begin::Description-->
                                                            ...
                                                            <div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<select class="form-select mb-2" name="status"
																		...
																		data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																		<option></option>
                                                                        <option value="active" {{ $department->status === 'active' ? 'selected' : '' }}>{{ __('general.active') }}</option>
                                                                        <option value="disabled" {{ $department->status === 'disabled' ? 'selected' : '' }}>{{ __('general.disabled') }}</option>
																	</select>
																	<!--end::Select2-->
																</div>
																<!--end::Input group-->
