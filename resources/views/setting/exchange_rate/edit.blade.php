...
<head>
	...
	<title>Link Masr | Update Rate</title>
					...
					<div class="d-flex flex-column flex-column-fluid">
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<h1
											...
											{{ __('general.update_exchange_rate') }}</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Form-->
								<form action="{{route('exchangeRates.update' , $exchangeRate->id)}}" method="POST" class="form d-flex flex-column flex-lg-row"
													...
													<div class="card card-flush py-4">
														...
														<div class="card-header">
															<div class="card-title">
																<h2>{{ __('general.main_data') }} <span style="font-size: 14px; color: gray; margin-top: -5px;"> {{ __('general.default_currency') }} : {{ $companyProfile->currency }}</span></h2>
															</div>
														</div>
														<!--end::Card header-->
														<!--begin::Card body-->
														<div class="card-body pt-0">
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<select name="currency" aria-label="Select a currency"
																	    ...
																	    <option value="{{ $currency->code }}" 
																	        {{ $exchangeRate->currency == $currency->code ? 'selected' : '' }}>
																	        {{ $currency->code }}
																	    </option>
																		@endforeach
																	</select>
																...
																<div class="fv-row w-100 flex-md-root">
																	<!--begin::Label-->
																	<label class="required form-label">{{ __('general.exchange_rate') }}</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="number" name="rate" data-label="{{ __('general.exchange_rate') }}" class="form-control mb-2" value="{{  $exchangeRate->rate }}" step="0.000001" min="0" data-placeholder="....." data-required="true">																	
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
                                                            </div>
