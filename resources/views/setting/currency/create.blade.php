...
<head>
	...
	<title>Link Masr | Create Currency</title>
					...
					<div class="d-flex flex-column flex-column-fluid">
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<h1
											...
											{{ __('general.create_new_currency') }}</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Form-->
								<form action="{{route('currencies.store')}}" method="POST" class="form d-flex flex-column flex-lg-row"
														...
														<div class="card-body pt-0">
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="code" class="form-control mb-2" value="{{ old('code') }}" data-required="true" data-minlength="2" data-maxlength="255"/>																		
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="symbol" class="form-control mb-2" value="{{ old('symbol') }}" data-required="true" data-minlength="2" data-maxlength="255"/>																		
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
                                                            </div>
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="decimal_separator"
																	    ...
																	    <option value="٫">٫ (Arabic Decimal)</option>
																	</select>
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="thousand_separator"
																	        data-control="select2" data-hide-search="true"
																	        data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																	    <option></option>
																	    <option value="," selected="selected">,</option>
																	    ...
																	    <option value="ʼ">ʼ</option>
																	    <option value="٬">٬ (Arabic Thousand)</option>
																	</select>
																	<!--end::Select2-->
																</div>
																<!--end::Input group-->
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="currency_placement"
																		data-control="select2" data-hide-search="true"
																		data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																		<option></option>
																		<option value="regular" selected="selected">{{ __('general.regular_currency') }}</option>
