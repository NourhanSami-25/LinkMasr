...
<head>
	...
	<title>Link Masr | Update Todo List</title>
					...
					<div class="d-flex flex-column flex-column-fluid">
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">
												<a href="{{ route('todos.index')}}" class="text-muted text-hover-primary">{{ __('general.todos') }}</a>
											</li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Form-->
								<form action="{{route('todos.update' , $todo->id)}}" method="POST" class="form d-flex flex-column flex-lg-row"
														...
														<div class="card-body pt-0">
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="subject" class="form-control mb-2" value="{{$todo->subject}}" data-required="true" data-minlength="3" data-maxlength="255"/>																		
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
                                                                <!--begin::Input group-->
																<div class="fv-row w-100 flex-md-root">
																	...
																	<select class="form-select mb-2" name="status"
																		...
																		<option></option>
                                                                        <option value="pending" {{ $todo->status === "pending" ? 'selected' : '' }}>{{ __('general.pending') }}</option>
                                                                        <option value="completed" {{ $todo->status === "completed" ? 'selected' : '' }}>{{ __('general.completed') }}</option>
																	</select>
																	<!--end::Select2-->
																</div>
																<!--end::Input group-->
																...
																<div class="fv-row w-100 flex-md-root">
                                                                    <!--begin::Label-->
																	<label class="required form-label">{{ __('general.priority') }}</label>
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="priority"
																		...
																		data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																		<option></option>
                                                                        <option value="normal" {{ $todo->priority === "normal" ? 'selected' : '' }}>{{ __('general.normal') }}</option>
                                                                        <option value="important" {{ $todo->priority === "important" ? 'selected' : '' }}>{{ __('general.important') }}</option>
                                                                        <option value="urgent" {{ $todo->priority === "urgent" ? 'selected' : '' }}>{{ __('general.urgent') }}</option>
																	</select>
																	<!--end::Select2-->
																</div>
																<!--end::Input group-->
                                                            ...
                                                            <div class="d-flex flex-wrap gap-5 mb-5">
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<textarea type="text" name="description" class="form-control mb-2" rows="3" data-minlength="5" data-maxlength="5000">{{$todo->description}}"</textarea>																		
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
															</div>
