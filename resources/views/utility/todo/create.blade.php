...
<head>
	...
	<title>Link Masr | Create Todo List</title>
					...
					<div class="d-flex flex-column flex-column-fluid">
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<h1
											...
											{{ __('general.create_new_todo_list') }}</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Form-->
								<form action="{{route('todos.store')}}" method="POST" class="form d-flex flex-column flex-lg-row"
														...
														<div class="card-body pt-0">
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<select class="form-select mb-2" name="priority" data-label="{{ __('general.priority') }}"
																		...
																		data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																		<option></option>
                                                                        <option value="normal" selected="selected">{{ __('general.normal') }}</option>
                                                            ...
                                                            <div class="d-flex flex-wrap gap-5 mb-5">
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<textarea type="text" name="description" data-label="{{ __('general.description') }}" class="form-control mb-2" rows="3"  data-minlength="5" data-maxlength="5000"></textarea>																		
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
															</div>
