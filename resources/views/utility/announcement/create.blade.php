...
<head>
	...
	<title>Link Masr | Create Announcement</title>
					...
					<div class="d-flex flex-column flex-column-fluid">
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<h1
											...
											{{ __('general.create_new_announcement') }}</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Form-->
								<form action="{{route('announcements.store')}}" method="POST" class="form d-flex flex-column flex-lg-row"
														...
														<div class="card-body pt-0">
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="subject" data-label="{{ __('general.subject') }}" class="form-control mb-2" value="{{ old('subject') }}" data-required="true" data-minlength="3" data-maxlength="255"/>																		
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
                                                                <!--begin::Input group-->
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="number" name="expire_after"  data-label="{{ __('general.expire_after') }}" class="form-control mb-2" value="{{ old('expire_after') }}" data-required="true" min="1"/>																		
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
                                                            </div>
                                                            ...
                                                            <div class="d-flex flex-wrap gap-5 mb-5">
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<textarea type="text" name="message" data-label="{{ __('general.message') }}" class="form-control mb-2" rows="3" data-required="true" data-minlength="5" data-maxlength="5000"></textarea>																		
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
															</div>
                                                            ...
                                                            <div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="show_staff" data-label="{{ __('general.show_staff') }}"
																		data-control="select2" data-hide-search="true"
																		data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																		<option></option>
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="show_clients" data-label="{{ __('general.show_clients') }}"
																		data-control="select2" data-hide-search="true"
																		data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																		<option></option>
																		<option value="1" selected="selected">{{ __('general.yes') }}</option>
																...
																<div class="fv-row w-100 flex-md-root">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select mb-2" name="show_name" data-label="{{ __('general.show_name') }}"
																		data-control="select2" data-hide-search="true" 
																		data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																		<option></option>
																		<option value="1" selected="selected">{{ __('general.yes') }}</option>
