<div class="tab-pane fade" id="kt_customer_view_reminders" role="tabpanel">
	...
	<div class="card pt-4 mb-6 mb-xl-9">
			...
			<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
				...
				<div class="w-150px">
					...
					<select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
						data-placeholder="{{ __('general.status_filter') }}" data-kt-table="tasks_table"
						...
						<option value="passed">{{ __('general.passed') }}</option>
					</select>
					<!--end::Select2-->
				</div>
				<!--end::Filter-->
				...
				<div id="tasks_table_export_menu"
					...
					<!--begin::Menu item-->
					<div class="menu-item px-3">
						<a href="#" class="menu-link px-3" data-kt-export="excel">{{ __('general.export_excel') }}</a>
					</div>
					<!--end::Menu item-->
					<!--begin::Menu item-->
					<div class="menu-item px-3">
						<a href="#" class="menu-link px-3" data-kt-export="csv">{{ __('general.export_csv') }}</a>
					</div>
					<!--end::Menu item-->
					<!--begin::Menu item-->
					<div class="menu-item px-3">
						<a href="#" class="menu-link px-3" data-kt-export="pdf">{{ __('general.export_pdf') }}</a>
					</div>
					<!--end::Menu item-->
				</div>
				...
				<div class="d-flex align-items-center gap-2 gap-lg-3">
					<a href="#" class="btn btn-flex btn-primary h-40px fs-7 fw-bold" data-bs-toggle="modal"
						data-bs-target="#kt_modal_new_target_create_reminder">{{ __('general.create_new_reminder') }}</a>
				</div>
				<!--end::Export dropdown-->
				@endhasAccess
			</div>
		...
		<div class="card-body pt-0 pb-5">
			<!--begin::Table-->
			<table class="table align-middle table-row-dashed kt-datatable gy-5" id="reminders_table">
				...
				<tbody class="fs-6 fw-semibold text-gray-800">
					@foreach($reminders as $reminder)
						...
						<tr>
							...
							<td class="text-start"><a href="#" class="text-gray-800 text-hover-primary mb-1"
									data-bs-toggle="modal"
									data-bs-target="#kt_modal_new_target_reminder_show_{{ $reminder->id }}">{{ __('general.' . str_replace(' ', '_', strtolower($reminder->subject))) }}</a>
							</td>
							<td class="text-start">{{ $reminder->date }}</td>
							<td class="text-start" class="text-start">
								<div class="badge 
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
									...
									<div class="menu-item px-3">
										<a href="#" data-bs-toggle="modal"
											data-bs-target="#kt_modal_new_target_reminder_show_{{ $reminder->id }}"
									...
									<div class="menu-item px-3">
										<a href="#" data-bs-toggle="modal"
											data-bs-target="#kt_modal_new_target_reminder_edit_{{ $reminder->id }}"
									...
									<div class="menu-item px-3">
										<form id="delete-form-{{ $reminder->id }}"
											...
											<div class="menu-item">
												<button type="button"
													onclick="showConfirmation('{{ addslashes($reminder->message) }}', '{{ $reminder->id }}');"
													class="dropdown-item menu-link fw-bold text-danger">{{ __('general.delete') }}</button>
											</div>
										</form>
									</div>
									<!--end::Menu item-->
...
@include('reminder.create', ['item' => $task])