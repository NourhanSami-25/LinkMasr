...
<head>
	...
	<title>Link Masr | Create CreditNote</title>
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-1 m-0">
											{{ __('general.create_new_creditNote') }}</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
										...
										<div class="card">
											...
											<div class="card-body p-12">
												<!--begin::Form-->
												<form  id="kt_invoice_form" action="{{route('creditNotes.store')}}" method="POST" enctype="multipart/form-data">
													@csrf													
													<!--begin::Wrapper-->
													<div class="d-flex flex-column align-items-start flex-xxl-row">
														...
														<div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4"
															...
															<input name="number" data-label="{{ __('general.number') }}" class="form-control form-control-flush fw-bold text-gray-800 fs-3 w-125px" value="{{$creditNote_number}}" placehoder="2021001..."data-type="number" data-required="true"/>
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
											...
											<div class="card-body p-10">
												...
												<div class="mb-5">
													...
													<select name="status" data-label="{{ __('general.status') }}" aria-label="Select status"
															...
															<option value="partially" >{{ __('general.partially_paid') }}</option>
												...
												<div class="mb-8">
													<label
														...
														<input class="form-check-input" type="checkbox" name="create_payment" data-label="{{ __('general.create_payment') }}"
															value="1" />
													</label>
													<!--end::Option-->
												</div>
