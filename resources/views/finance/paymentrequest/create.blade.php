...
<head>
	...
	<title>Link Masr | Create PaymentRequest</title>
...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true"
								...
								<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
									...
									<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
										...
										<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-1 m-0">
											{{ __('general.create_new_paymentRequest') }}</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
											...
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">
												<a href="{{ route('paymentRequests.index')}}" class="text-muted text-hover-primary">{{ __('general.paymentRequests') }}</a>
											</li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										<a href="{{route('paymentRequests.index')}}" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">{{ __('general.paymentRequests') }}</a>
									...
									<div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
										...
										<div class="card">
											...
											<div class="card-body p-12">
												<!--begin::Form-->
												<form  id="kt_invoice_form" action="{{route('paymentRequests.store')}}" method="POST" enctype="multipart/form-data">
													@csrf													
													<!--begin::Wrapper-->
													<div class="d-flex flex-column align-items-start flex-xxl-row">
														...
														<div class="d-flex align-items-center flex-equal fw-row me-4 order-2"
															...
															title="Specify paymentRequest date">
															<!--begin::Date-->
														...
														<div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4"
															data-bs-toggle="tooltip" data-bs-trigger="hover"
															title="{{ __('general.paymentRequest_number_info') }}">
															<span class="fs-2x fw-bold text-gray-800">{{ __('general.paymentRequest_#') }}</span>
															<input name="number" data-label="{{ __('general.number') }}" class="form-control form-control-flush fw-bold text-gray-800 fs-3 w-125px" value="{{$paymentRequest_number}}" placehoder="2021001..."data-type="number" data-required="true"/>
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div class="d-flex align-items-center justify-content-end flex-equal order-3 fw-row"
															data-bs-toggle="tooltip" data-bs-trigger="hover"
															title="Specify paymentRequest due date">
															<!--begin::Date-->
															...
															<div class="position-relative d-flex align-items-center w-150px">
																...
																<input class="flatpickr-date form-control form-control-transparent fw-bold pe-5" 
																	placeholder="{{ __('general.select_date') }}" name="due_date" data-label="{{ __('general.due_date') }}" value="{{ date('Y-m-d') }}" data-type="date"/>
																<!--end::Datepicker-->
																<!--begin::Icon-->
													...
													<div class="mb-0">
														...
														<div class="row gx-10 mb-5">
															...
															<div class="d-flex flex-wrap gap-5 mb-5">
																...
																<div class="fv-row w-100 flex-md-root">
																	<!--begin::Label-->
																	<label class="required form-label">{{ __('general.related_with') }}</label>
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select form-select-solid mb-2 task-relation-type" name="related" data-label="{{ __('general.related_with') }}"
																	    data-control="select2" data-hide-search="true"
																	    data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
																	    <option></option>
																	    <option value="project" {{ request()->has('project_id') ? 'selected' : (old('related') == 'project' ? 'selected' : '') }}>{{ __('general.project') }}</option>
																	    <option value="client" {{ request()->has('client_id') ? 'selected' : (old('related') == 'client' ? 'selected' : '') }}>{{ __('general.client') }}</option>
																	    <option value="task" {{ request()->has('task_id') ? 'selected' : (old('related') == 'task' ? 'selected' : '') }}>{{ __('general.task') }}</option>
																	</select>
																...
																<div class="fv-row w-100 flex-md-root secondary-selects select-project">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select form-select-solid mb-2" name="project_id" data-label="{{ __('general.project') }}"
																...
																<div class="fv-row w-100 flex-md-root secondary-selects select-client" style="display: none;">
																	...
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select form-select-solid mb-2" name="client_id" data-label="{{ __('general.client') }}"
																	    data-control="select2"
																	    data-placeholder="{{ __('general.select_an_option') }}">
																	    <option></option>
																...
																<!--begin::Input group-->
																<div class="fv-row w-100 flex-md-root secondary-selects select-task" style="display: none;">
																	<!--begin::Label-->
																	<label class="required form-label">{{ __('general.task_name') }}</label>
																	<!--end::Label-->
																	<!--begin::Select2-->
																	<select class="form-select form-select-solid mb-2" name="task_id" data-label="{{ __('general.task_name') }}"
																	    data-control="select2"
																	    data-placeholder="{{ __('general.select_an_option') }}">
																	    <option></option>
															...
															<table class="table g-5 gs-0 mb-0 fw-bold text-gray-700"
																	...
																	<tr class="border-bottom border-bottom-dashed"
																		...
																		<td class="pe-7">
																			<input type="text"
																				...
																				name="finance_items[0][name]" placeholder="{{ __('general.item_name') }}" maxlength="100" required/>
																			<input type="text"
																				class="form-control form-control-solid"
																		...
																		<td class="ps-0">
																			<input
																				...
																				type="number" min="1" max="99999" name="finance_items[0][qty]"
																		...
																		<td>
																			<input type="number"
																				...
																				name="finance_items[0][amount]" min="1" max="99999999" placeholder="0.00"
																				value="0.00" data-kt-element="price" />
																		</td>
																		<td class="ps-0">
																			<input
																				class="form-control form-control-solid"
																				type="number" min="0" max="100" name="finance_items[0][tax]"
																				placeholder="0" value="0"
																				data-kt-element="tax" />
																		</td>
																		<td class="pt-8 text-end text-nowrap">
																			<span data-kt-element="item-total">0.00</span>
																			<input type="hidden" name="finance_items[0][subtotal]" value="0.00" data-kt-element="subtotal-input" />
																		</td>
																...
																<tfoot>
																	...
																	<tr colspan="2" class="border-bottom border-bottom-dashed ps-0">
																		...
																		<th>
																			<input class="form-control form-control-solid w-75" type="number" min="0" max="100" name="tax" placeholder="0" value="0" data-kt-element="invoice-tax" />
																		</th>
																		<th colspan="2" class="border-bottom border-bottom-dashed text-end">$ <span data-kt-element="invoice-tax-field">0.00</span></th>
																	</tr>
																	...
																	<tr colspan="2" class="border-bottom border-bottom-dashed ps-0">
																		...
																		<th>
																			<input class="form-control form-control-solid w-75" type="number" min="0" max="100" name="discount" placeholder="0" value="0" data-kt-element="invoice-discount" />
																		</th>
																		<th colspan="2" class="border-bottom border-bottom-dashed text-end">$ <span data-kt-element="invoice-discount-field">0.00</span></th>
																	</tr>
																	...
																	<tr colspan="2" class="border-bottom border-bottom-dashed ps-0">
																		...
																		<th>
																			<input class="form-control form-control-solid w-75" type="number" min="0" max="99999999" name="fixed_discount" placeholder="0" value="0" data-kt-element="invoice-fixed-discount" />
																		</th>
																		<th colspan="2" class="border-bottom border-bottom-solid text-end">$ <span data-kt-element="invoice-fixed-discount-field">0.00</span></th>
																	</tr>
														...
														<div class="row gx-10">
															<div class="col">
																...
																<textarea name="client_note" data-label="{{ __('general.client_note') }}" class="form-control form-control-solid" rows="3" placeholder="{{ __('general.note_info') }}"></textarea>
															</div>
														</div>
														<!--end::Notes-->
														{{-- <!--begin::bank details-->
											...
											<div class="card-body p-10">
												...
												<div class="row">
													<div class="col mb-5">
														...
														<select name="status" data-label="{{ __('general.status') }}" aria-label="Select status"
															...
															<option value="sent" selected>{{ __('general.sent') }}</option>
												...
												<div class="row">
													<div class="col mb-5">
														...
														<!--end::Label-->
														<!--begin::Select-->
														<select name="discount_type" data-label="{{ __('general.discount_type') }}" aria-label="Select discount type"
															...
															<option value="before_tax" selected>{{ __('general.before_tax') }}</option>
															<option value="after_tax" >{{ __('general.after_tax') }}</option>
														</select>
														<!--end::Select-->
													</div>
												</div>
												<div class="row">
													<div class="col mb-5">
														...
														<!--end::Label-->
														<!--begin::Select-->
														<select name="discount_amount_type" data-label="{{ __('general.discount_amount_type') }}" aria-label="Select discount type"
															data-control="select2" data-hide-search="true" data-placeholder="....."
															class="form-select form-select-solid" data-kt-element="discount-amount">
															<option value="percentage" selected>{{ __('general.percentage') }}</option>
															<option value="fixed_amount">{{ __('general.fixed_amount') }}</option>
														</select>
														<!--end::Select-->
													</div>
												</div>
												...
												<div class="mb-8">
													...
													<label
														...
														<span class="form-check-label ms-0 fw-bold fs-6 text-gray-700">{{ __('general.create_finance_payment') }}</span>
														<input class="form-check-input" type="checkbox" name="create_payment" data-label="{{ __('general.create_finance_payment') }}"
															value="1" />
													</label>
													<!--end::Option-->
												</div>
												...
												<!--begin::Actions-->
												<div class="mb-0">
												    <!-- Save as Regular PaymentRequest -->
	...
	<!--script for related to-->
	<script src="{{ asset('assets/js/models/finance/related.js') }}"></script> 
