<div class="modal fade" id="kt_modal_new_target_create_reminder" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-800px">
		...
		<div class="modal-content rounded">
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
				<!--begin:Form-->
				<form action="{{ route('reminders.store') }}" method="POST" id="kt_modal_new_target_form" class="form" enctype="multipart/form-data">
					@csrf

					<input class="form-control form-control-solid"  type="number" name="referable_id" value="{{$item->id}}" hidden/>
                    <input class="form-control form-control-solid"  type="text" name="referable_type" value="{{ get_class($item) }}" hidden/>
					
                    <!--begin::Heading-->
					<div class="mb-5 text-center">
						<!--begin::Title-->
						<h1 class="mb-3">{{ __('general.create_new_reminder') }}</h1>
						<!--end::Title-->
					</div>
					<!--end::Heading-->
					...
					<div class="row g-9 mb-8">
						...
						<div class="col-md-6 fv-row">
						    ...
						    <!--end::Label-->
						    <input type="text" class="form-control" name="subject" data-required="true"/>
						</div>
						<!--end::Col-->
						<!--begin::Col-->
						<div class="col-md-6 fv-row">
					...
					<div class="row g-9 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<div class="position-relative d-flex align-items-center">
								<!--begin::Datepicker-->
								<input name="date" placeholder="{{ __('general.select_a_date') }}" class="flatpickr-date form-control mb-2" data-type="dateTime" data-required="true"/>
								<!--end::Datepicker-->
							</div>
							<!--end::Input-->
						</div>
						...
						<div class="col-md-6 fv-row">	
							...
							<select class="form-select" data-control="select2"
								...
								<option value="important">{{__('general.important')}}</option>
					...
					<div class="row g-9 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<div class="position-relative d-flex align-items-center">
								...
								<!--end::Icon-->
								<!--begin::Datepicker-->
						        <input type="number" class="form-control"  name="remind_before" data-type="number" min="0" value="0" data-required="true"/>
								<!--end::Datepicker-->
							</div>
							<!--end::Input-->
						</div>
						...
						<div class="col-md-6 fv-row">
							...
							<select class="form-select" data-control="select2"
								data-hide-search="true" data-placeholder="{{ __('general.select_an_option') }}"
								name="remind_at_event" data-required="true">
