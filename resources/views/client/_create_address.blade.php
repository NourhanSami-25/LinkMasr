<div class="modal fade" id="kt_modal_new_target_create_address" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-650px">
		...
		<div class="modal-content rounded">
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
				<!--begin:Form-->
				<form action="{{ route('addresses.store') }}" method="POST" id="kt_modal_new_target_form" class="form" enctype="multipart/form-data">
					@csrf
					...
					<div class="row g-9 mt-5 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<div class="position-relative d-flex align-items-center">
								...
								<!--end::Icon-->
								<!--begin::input-->
						        <input class="form-control" name="country" data-minlength="3" data-maxlength="255" data-required="true"/>
					...
					<div class="row g-9 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<div class="position-relative d-flex align-items-center">
								...
								<!--end::Icon-->
								<!--begin::input-->
						        <input class="form-control" name="city" data-minlength="3" data-maxlength="255" data-required="true"/>
								<!--end::input-->
							</div>
							<!--end::Input-->
						</div>
					...
					<div class="row g-9 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<div class="position-relative d-flex align-items-center">
								...
								<!--end::Icon-->
								<!--begin::input-->
						        <input class="form-control" name="street_name" data-minlength="3" data-maxlength="255" data-required="true"/>
								<!--end::input-->
							</div>
							<!--end::Input-->
						</div>
					...
					<div class="row g-9 mb-8">
						...
						<div class="col-md-4 fv-row">
							...
							<div class="position-relative d-flex align-items-center">
								...
								<!--end::Icon-->
								<!--begin::input-->
						        <input class="form-control" name="building_number"/>
								<!--end::input-->
							</div>
							<!--end::Input-->
						</div>
