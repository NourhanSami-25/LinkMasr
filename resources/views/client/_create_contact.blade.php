<div class="modal fade" id="kt_modal_new_target_create_contact" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-650px">
		...
		<div class="modal-content rounded">
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
				<!--begin:Form-->
				<form action="{{ route('client-contacts.store') }}" method="POST" id="kt_modal_new_target_form" class="form" enctype="multipart/form-data">
					@csrf

                    <!--begin::Heading-->
					<div class="mb-5 text-center">
						<!--begin::Title-->
						<h1 class="mb-3">{{ __('general.create_new_contact') }}</h1>
						<!--end::Title-->
					</div>
					<!--end::Heading-->
					...
					<div class="row g-9 mt-5 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<div class="position-relative d-flex align-items-center">
								...
								<!--end::Icon-->
								<!--begin::input-->
						        <input class="form-control" name="name" data-minlength="3" data-maxlength="255" data-required="true"/>
					...
					<div class="row g-9 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<div class="position-relative d-flex align-items-center">
								...
								<!--end::Icon-->
								<!--begin::input-->
						        <input class="form-control" name="email" data-minlength="3" data-maxlength="255" data-type="email" data-required="true" />
								<!--end::input-->
							</div>
							<!--end::Input-->
						</div>
					...
					<div class="row g-9 mb-8"> 
						...
						<div class="col-md-12 fv-row">	
							...
							<select class="form-select" data-control="select2"
								...
								name="is_primary">
								<option value="0" selected="selected">{{__('general.no')}}</option>
