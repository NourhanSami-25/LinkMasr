...
@section('content')
<!--begin::Form-->
<form action="{{route('clients.update' , $client->id)}}" method="POST" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row">
    @csrf
    @method('PUT')
    <!--begin::Aside column-->
    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body text-center pt-0">
                ...
                <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3 {{$client->type == 'person' ? 'avatar-person' : 'avatar-company'}}" data-kt-image-input="true" id="avatarBox" style="background-image: url('{{ $client->photo ? asset($client->photo) : '' }}')">
                    <!--begin::Preview existing avatar-->
                    <div class="image-input-wrapper w-150px h-150px" style="background-image: url('{{ $client->photo ? asset($client->photo) : '' }}')"></div>
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <select class="form-select mb-2" data-control="select2" name="status" data-label="{{ __('general.status') }}"
                    ...
                    <option value="active" @selected($client->status == 'active')>{{ __('general.active') }}</option>
                    <option value="disabled" @selected($client->status == 'disabled')>{{ __('general.disabled') }}</option>
                </select>
                <!--end::Select2-->
                <!--begin::Description-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <select class="form-select mb-2" name="type" data-label="{{ __('general.type') }}"
                                    ...
                                    <option value="person" @selected($client->type == 'person')>{{ __('general.person') }}</option>
                                <option value="company" @selected($client->type == 'company')>{{ __('general.company') }}</option>
                                <option value="government" @selected($client->type == 'government')>{{ __('general.government') }}</option>
                                </select>
                                <!--end::Select2-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="d-flex flex-wrap gap-5 mb-5">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="name" data-label="{{ __('general.name') }}" value="{{$client->name}}" class="form-control mb-2"
                            ...
                            <div class="d-flex flex-wrap gap-5 mb-5">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="email" name="email" data-label="{{ __('general.email') }}" value="{{$client->email}}" class="form-control mb-2"
                                            data-required="true" data-maxlength="50"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{ __('general.mandatory_field_message') }}</div>
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="phone" data-label="{{ __('general.phone') }}" value="{{$client->phone}}" class="form-control mb-2"
                                            data-required="true" data-minlength="5" data-maxlength="50"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{ __('general.mandatory_field_message') }}</div>
                                    <!--end::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="phone2" data-label="{{ __('general.phone2') }}" value="{{$client->phone2}}" class="form-control mb-2"
                                            data-maxlength="50"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                            ...
                            <div class="d-flex flex-wrap gap-5 mb-5">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                                    <select class="form-select mb-2" name="currency" data-label="{{ __('general.currency') }}"
                                        data-control="select2" data-hide-search="true"
                                        data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
                                        @foreach($currencies as $currency)
                                            <option value="{{$currency->code}}" @selected($client->currency == $currency->code)>{{$currency->code}}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                </div>
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                                    <select class="form-select mb-2" name="default_language" data-label="{{ __('general.default_language') }}"
                                        data-control="select2" data-hide-search="true"
                                        data-placeholder="{{ __('general.select_an_option') }}" data-required="true">
                                        <option value="arabic" @selected($client->default_language == 'arabic')>arabic</option>
                                        <option value="english" @selected($client->default_language == 'english')>english</option>
                                    </select>
                                    <!--end::Select2-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="website" data-label="{{ __('general.website') }}"
                                    value="{{$client->website}}" data-maxlength="255"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{ __('general.optional_message') }}</div>
                                    <!--end::Description-->
                            ...
                            <div class="d-flex flex-wrap gap-5 mb-5">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="tax_number" data-label="{{ __('general.tax_number') }}"
                                            value="{{$client->tax_number}}" data-maxlength="50"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{ __('general.optional_message') }}</div>
                                    <!--end::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="computer_number" data-label="{{ __('general.computer_number') }}"
                                            value="{{$client->computer_number}}" maxlength="20"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{ __('general.optional_message') }}</div>
                                    <!--end::Description-->
                            ...
                            <div class="mb-5 mt-5">
                                ...
                                <textarea class="form-control mb-2"
                                    name="bio" data-label="{{ __('general.bio') }}" maxlength="1024">{{$client->bio}}</textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">{{ __('general.optional_message') }}</div>
                                <!--end::Description-->
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateAvatar(value) {
        if(!box) return;
        box.classList.remove("avatar-company", "avatar-person");
