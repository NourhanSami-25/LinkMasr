<div class="tab-pane fade" id="kt_customer_view_files" role="tabpanel">
    ...
    <div class="card pt-4 mb-6 mb-xl-9">
        ...
        <div class="card-header border-0">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="#" class="btn btn-flex btn-outline btn-primary h-40px fs-7 fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target_upload_file" data-category="client">{{ __('general.upload_new_file') }}</a>
                @endhasAccess
