    ...
    <div class="card pt-4 mb-6 mb-xl-9">
        ...
        <div class="card-header border-0">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{route('projects.create')}}" class="btn btn-flex btn-outline btn-primary h-40px fs-7 fw-bold" target="_blank">{{ __('general.create_new') }}</a>
				@endhasAccess
                @hasAccess('project','view')
                <a href="{{route('projects.index' )}}" class="btn btn-flex btn-outline btn-primary h-40px fs-7 fw-bold" target="_blank">{{ __('general.view_all') }}</a>
                @endhasAccess
            </div>
            <!--end::Card toolbar-->
        </div>
            ...
            <table class="table align-middle table-row-dashed kt-datatable gy-5"
                ...
                <tbody class="fs-6 fw-semibold text-gray-800">
                    ...
                    <tr>
                        ...
                        <td class="text-start">{{ __('general.' . $project->status) }}</td>
