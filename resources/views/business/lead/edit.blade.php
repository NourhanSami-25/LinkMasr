...
<head>
	...
	<title>Link Masr | Update Lead</title>
									...
									<div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
										...
										<div class="card">
											...
											<div class="card-body p-12">
												<!--begin::Form-->
												<form  id="kt_invoice_form" action="{{route('leads.update' , $lead->id)}}" method="POST" enctype="multipart/form-data">
													@csrf
													@method('PUT')
													<!--begin::Wrapper-->
													<div class="d-flex flex-column align-items-start flex-xxl-row">
														...
														<div class="d-flex align-items-center flex-equal fw-row me-4 order-2"
															...
															<div
																...
																<input
																	...
																	placeholder="{{ __('general.select_date') }}" name="created_since" value="{{$lead->created_since}}" data-required="true"/>
																<!--end::Datepicker-->
																<!--begin::Icon-->
														...
														<div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4"
															data-bs-toggle="tooltip" data-bs-trigger="hover"
															title="{{ __('general.Lead_number_info') }}">
															<span class="fs-2x fw-bold text-gray-800">{{ __('general.lead_#') }}</span>
															<input type="text" name="number" class="form-control form-control-flush fw-bold text-gray-800 fs-3 w-125px" value="{{$lead->number}}" placehoder="2021001..." data-required="true" />
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div class="d-flex align-items-center justify-content-end flex-equal order-3 fw-row"
															data-bs-toggle="tooltip" data-bs-trigger="hover"
															title="Specify Lead due date">
															{{-- <!--begin::Date-->
															...
															<div
																...
																<input
																	class="form-control form-control-transparent fw-bold pe-5"
																	placeholder="{{ __('general.select_date') }}" name="due_date" value="{{$lead->due_date}}" />
																<!--end::Datepicker-->
																<!--begin::Icon-->
													...
													<div class="mb-0">
														...
														<div class="row gx-10 mb-5">
															...
															<div class="col-lg-6">
																...
																<div class="mb-5">
																	<input type="text" 
																		class="form-control form-control-solid mb-2" name="client_name" value="{{$lead->client_name}}"
															...
															<div class="col-lg-6">
																...
																<div class="mb-5">
																	<input type="text" 
																		class="form-control form-control-solid mb-2" name="subject" value="{{$lead->address}}"
																		placeholder="{{ __('general.address') }}" data-required="true" data-minlength="5"/>
																</div>
																<!--end::Input group-->
															</div>
															<!--end::Col-->
															...
															<div class="col-6">
																...
																<div class="mb-5">
																	<input type="email" maxlength="50"
																		class="form-control form-control-solid" name="email" value="{{$lead->email}}"
															...
															<div class="col-6">
																...
																<div class="mb-5">
																	<input type="text" maxlength="50"
																		class="form-control form-control-solid" name="phone" value="{{$lead->phone}}"
														...
														<div class="row gx-10">
															<div class="col-6">
																...
																<div class="mb-5">
																	<input type="text" 
																		class="form-control form-control-solid mb-2" name="subject" value="{{$lead->subject}}"
																		placeholder="{{ __('general.lead_subject') }}" data-required="true" data-minlength="5"/>
																</div>
															</div>
															<div class="col-6">
																...
																<div class="mb-5">
																	<input type="number" data-type="number" data-min="0" data-required="true"
																		class="form-control form-control-solid mb-2" name="lead_value" value="{{$lead->lead_value}}"
																		placeholder="{{ __('general.lead_value') }}"/>
																</div>
															</div>
														</div>
														<!--end::Row-->
														...
														<div class="row gx-10 mb-5">
															<div class="col-6">
																...
																<select name="source" aria-label="Select a Timezone" data-hide-search="true"
																    data-control="select2" data-placeholder="{{ __('general.lead_source') }}"
																    class="form-select form-select-solid mb-2" data-required="true">
																    <option></option>
																    <option value="facebook" {{ $lead->source == 'facebook' ? 'selected' : '' }}>{{ __('general.facebook') }}</option>
																    <option value="instagram" {{ $lead->source == 'instagram' ? 'selected' : '' }}>{{ __('general.instagram') }}</option>
																    <option value="linkedin" {{ $lead->source == 'linkedin' ? 'selected' : '' }}>{{ __('general.linkedin') }}</option>
																    <option value="google" {{ $lead->source == 'google' ? 'selected' : '' }}>{{ __('general.google') }}</option>
																</select>
															</div>
															<div class="col-6">
																<label class="form-label fs-6 fw-bold text-gray-700 mb-3">{{ __('general.website') }}</label>
																<div class="mb-5">
																	<input type="text" data-type="text" maxlength="255"
																		class="form-control form-control-solid" name="website"  value="{{$lead->website}}"
												...
												<div class="mb-5">
													...
													<select name="sale_agent" aria-label="Select a Timezone"
														...
														@foreach($users as $user)
													        <option value="{{ $user->id }}" {{ $lead->sale_agent == $user->id ? 'selected' : '' }}>
													            {{ $user->name }}
													        </option>
													    @endforeach
													</select>
												...
												<div class="row">
													<div class="col mb-5">
														...
														<select name="status" aria-label="Select status"
														    ...
														    class="form-select form-select-solid">
														    <option value="in_progress" {{ $lead->status == 'in_progress' ? 'selected' : '' }}>{{ __('general.in_progress') }}</option>
														    <option value="contracted" {{ $lead->status == 'contracted' ? 'selected' : '' }}>{{ __('general.contracted') }}</option>
														    <option value="canceled" {{ $lead->status == 'canceled' ? 'selected' : '' }}>{{ __('general.canceled') }}</option>
														</select>
														<!--end::Select-->
													</div>
												</div>
