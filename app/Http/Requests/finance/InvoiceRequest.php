...
class InvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'pymentRequest_id' => 'nullable|integer',
    ...
    public function messages(): array
    {
        ...
        return [
            'pymentRequest_id.integer' => 'The pyment request id ID must be an integer.',
            ...
            'number.integer' => 'Invoice number must be an integer.',
            'number.unique' => 'This invoice number has already been taken.',
