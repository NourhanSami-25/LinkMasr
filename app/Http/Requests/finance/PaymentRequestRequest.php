...
class PaymentRequestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $paymentRequestId = $this->route('paymentRequest');
        ...
        return [
            ...
            'number' => [
                ...
                'integer',
                $isUpdate
                    ? Rule::unique('paymentrequests', 'number')->ignore($paymentRequestId)
                    : 'unique:paymentrequests,number',
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'number.required' => 'PaymentRequest number is required.',
            'number.integer' => 'PaymentRequest number must be an integer.',
            'number.unique' => 'This paymentRequest number has already been taken.',
            ...
            'date.required' => 'The paymentRequest date is required.',
            'date.date' => 'The paymentRequest date must be a valid date.',
            'due_date.date' => 'The due date must be a valid date.',
            'due_date.after_or_equal' => 'Due date must be equal to or after the paymentRequest date.',
