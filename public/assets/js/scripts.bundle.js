...
KTUtil.onDOMContentLoaded(function () {
    ...
    // 🔁 Read the cookie and apply sidebar state before init
    var sidebarState = KTCookie.get("sidebar_minimize_state");
    var body = document.body;
    var toggle = document.querySelector('#kt_app_sidebar_toggle');
