...
var KTAppEcommerceSaveProduct = function () {
    ...
    const handleStatus = () => {
        ...
        const datepicker2 = document.getElementById('kt_ecommerce_add_product_status_datepicker2');
        ...
        $('#kt_ecommerce_add_product_status_datepicker2').flatpickr({
            enableTime: true,
            dateFormat: "Y-m-d H:i",
        });
        ...
        const showDatepicker = () => {
            ...
            datepicker2.parentNode.classList.remove('d-none');
        }

        const hideDatepicker = () => {
            datepicker.parentNode.classList.add('d-none');
            datepicker2.parentNode.classList.add('d-none');
        }
    ...
    const handleConditions2 = () => {
        const allConditions = document.querySelectorAll('[name="method"][type="radio"]');
        const conditionMatch = document.querySelector('[data-kt-ecommerce-catalog-add-category="auto-options2"]');
        allConditions.forEach(radio => {
            radio.addEventListener('change', e => {
                if (e.target.value === '1') {
                    conditionMatch.classList.remove('d-none');
