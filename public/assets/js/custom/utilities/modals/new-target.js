...
var KTModalNewTarget = function () {
	...
	var initForm = function () {
		...
		var next_date = $(form.querySelector('[name="next_date"]'));
		next_date.flatpickr({
			enableTime: true,
			dateFormat: "Y-m-d, H:i",
		});

		var update_date = $(form.querySelector('[name="update_date"]'));
		update_date.flatpickr({
			enableTime: true,
			dateFormat: "Y-m-d, H:i",
		});

		var status_date = $(form.querySelector('[name="status_date"]'));
		status_date.flatpickr({
			enableTime: true,
			dateFormat: "Y-m-d, H:i",
		});
